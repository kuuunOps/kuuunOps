...
MASTER_HOSTNAMES=node-1,node-2,node-3
# k8s内部的hostname
...
for instance in ${MASTER_HOSTNAMES[@]}; do
  scp ca.pem ca-key.pem  kube-apiserver-key.pem kube-apiserver.pem service-account-key.pem service-account.pem kube-front-proxy-ca.pem kube-front-proxy-client.pem kube-front-proxy-client-key.pem etcd-ca.pem apiserver-etcd-client.pem apiserver-etcd-client-key.pem root@${instance}:~/
done
